...
function(search, record, query, file, email) {
    ...
    // // Function to create Inter-Company Transfer Order
    // function createInterCompanyTransferOrder(item, objItemTOLoc) {
    //     var icSrRecord = record.create({
    //         type: record.Type.INTER_COMPANY_TRANSFER_ORDER
    //     });

    //     icSrRecord.setValue({ fieldId: 'tosubsidiary', value: objItemTOLoc.subsidiary });
    //     icSrRecord.setValue({ fieldId: 'subsidiary', value: 3 });
    //     icSrRecord.setValue({ fieldId: 'transferlocation', value: item.loc });
    //     icSrRecord.setValue({ fieldId: 'location', value: 3 });
    //     icSrRecord.setSublistValue({ sublistId: 'item', fieldId: 'item', line: 0, value: item.id });
    //     icSrRecord.setSublistValue({ sublistId: 'item', fieldId: 'department', line: 0, value: 25 });
    //     icSrRecord.setSublistValue({ sublistId: 'item', fieldId: 'class', line: 0, value: 3 });
    //     icSrRecord.setSublistValue({ sublistId: 'item', fieldId: 'quantity', line: 0, value: item.reorder });

    //     setItemMarkUp(icSrRecord, item);

    //     // Uncomment to save the record
    ...
    // function createTransferOrder(item, objItemTOLoc) {
    //     var srRecord = record.create({
    //         type: record.Type.TRANSFER_ORDER
    //     });

    //     srRecord.setValue({ fieldId: 'subsidiary', value: objItemTOLoc.subsidiary });
    //     srRecord.setValue({ fieldId: 'transferlocation', value: item.loc });
    //     srRecord.setValue({ fieldId: 'location', value: 3 });
    //     srRecord.setSublistValue({ sublistId: 'item', fieldId: 'item', line: 0, value: item.id });
    //     srRecord.setSublistValue({ sublistId: 'item', fieldId: 'department', line: 0, value: 25 });
    //     srRecord.setSublistValue({ sublistId: 'item', fieldId: 'class', line: 0, value: 3 });
    //     srRecord.setSublistValue({ sublistId: 'item', fieldId: 'quantity', line: 0, value: item.reorder });

    //     setItemMarkUp(srRecord, item);
